...
def get_data(month, year, post=POST, host=HOSTNAME,
             url=TRANSTAT_URL, frequency=FREQUENCY, folder_name="data"):
    """ get_data
    ...
    zip_file_name = folder_name + "/" + '{}.zip'.format(output_file)
    csv_file_name = folder_name + "/" + '{}.csv'.format(output_file)
